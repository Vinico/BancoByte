 ...
 * @author vini
 */
public class FormListaContas extends javax.swing.JFrame {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(FormListaContas.class.getName());
    ...
    private void AtualizarLista(){
        ...
        for (ContaBancaria contaBancaria : lista) {
            JLabel lbl = new JLabel(contaBancaria.getNumero() + " | "
                    + contaBancaria.getCorrentista().getNome() + " | "
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new FormListaContas().setVisible(true));
    }
